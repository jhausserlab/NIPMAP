...
hist(as.vector(as.matrix(CorpvalueMatrix)))

hist(as.vector(as.matrix(CorqvalueMatrix)))
...
file5 = paste(RESULT_DATA_PATH,"cells_niches_xs.json") %>% str_replace_all(" ", "") # sites centered on cells and niches weights
