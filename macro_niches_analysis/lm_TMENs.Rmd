...
#                           R2 = R2val.inter,error = 0,log10Scale = F,#error=err
#                           measure = "mean",savePlot = FALSE,namePlot = "ObsVSPred_lm2")
plot_obs_VS_pred_patient <- function(Y, B, R2, Omega,error = 0,log10Scale = FALSE,savePlot = FALSE,namePlot = " "){
  ...
  plots <- lapply(names_patients, function(x){
    ...
    #print(x)
    namePlot=x
    #print(t(B%*%t(Omega)[,avPatient$names]))
    #print(Y[x,])
    #print(B)
...
# }
lapply(plots,FUN =function(x) ggsave(paste0("./figs/ObsVSPreds/ObsVSPred_",x,".pdf"),x,height=4,width=5))
