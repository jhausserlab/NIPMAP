---
title: "phenotypes of CD4T cells and TMENS"
...
plot_3D_ternary_cell_markers("CD4-T", Markers.toPlot[1])
...
```{r m2}
plot_3D_ternary_cell_markers("CD4-T", Markers.toPlot[2])
```


```{r m3}
plot_3D_ternary_cell_markers("CD4-T", Markers.toPlot[3])
```
