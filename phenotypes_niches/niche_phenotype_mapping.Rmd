...
cMf <-correlation_niches_CM(markersCells.niches=MarkersCellsNiches,Markers=FuncMarkers,corrMeth="spearman",coreIntf=coreIntf2,nbNiches=NBNICHES,intf=NINTERFACE)#(markersCells.niches=MarkersCellsTMENS2,Markers=FuncMarkers,corrMeth="spearman",coreIntf=coreIntf2)
